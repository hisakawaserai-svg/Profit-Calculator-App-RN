...
export const ja = {
  ...
  list: {
    ...
    /**
     * まだ 1 件も記録していない人にだけ出す見出し。
     *
     * noRecordsTitle（「この期間の」）と分けるのは、**初めて開いた人は
     * 「期間」で切り替わっていることをまだ知らない**ため ── 月バーを触ったこともない
     * のに期間の話をされると、自分の操作のせいで隠れているのかと読めてしまう。
     */
    firstRecordTitle: 'まだ記録がありません',
