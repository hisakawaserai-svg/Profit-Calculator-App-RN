...
export const ja = {
  ...
  onboarding: {
     ...
     */
    presetBody: '販売サイト・送料は欄の横の印から、梱包材は電卓の中から選べます。選ぶシートの上端で、その場で登録もできます。設定タブの「{{section}}」からも登録できます。',
